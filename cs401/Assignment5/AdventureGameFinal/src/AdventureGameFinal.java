...
public class AdventureGameFinal extends Application {
  ...
  public void start(Stage primaryStage) {  
    ...
    //instead of doing the star method, you may do the following sections: 
    //buildPlayerSection();
    //buildEnemySection();
    //buildCenterSection();
    ...
    selectEnemyButton.setOnAction(e -> 
      {  
        setEnemyImage();
      });
   ...
   // if((playerSectionTitle != null))
    playerPane = new VBox(20, playerSectionTitle, playerListView, playerImageView, playerWeaponListView, 
      playerWeaponImageView, selectPlayerButton);
    ...
    enemyPane = new VBox(20, enemySectionTitle, enemyListView, enemyImageView, enemyWeaponListView, 
      enemyWeaponImageView, selectEnemyButton);
    ...
    numOfEnemyTitle = new Text ("Number of enemies");
    ...
    numOfRoundsTitle = new Text("Number of rounds");
  ...
  public void setPlayerImage(){
    ...
    if((selectedEnemy != null) && (selectedPlayer != null) && (selectedEnemyWeapon != null) && (selectedPlayerWeapon!= null) 
      && (playerIsSelected == true) && (enemyIsSelected == true))
  ...
  public void setEnemyImage(){
    ...
    if((selectedPlayer != null) && (selectedPlayerWeapon != null) && (selectedEnemy != null) && (selectedEnemyWeapon != null) 
      && (playerIsSelected == true) && (enemyIsSelected == true))
      runSimButton.setDisable(false);
  ...
  public void simulation(){
    ...
    if ((isNumEnmSelected1 == false)&&(isNumEnmSelected2 == false)&&(isNumEnmSelected3 == false)){
      numEnemyPerRnd = 4;
      
    }
    if ((isNumRndSelected1 == false)&&(isNumRndSelected2 == false)&&(isNumRndSelected3 == false)&&(isNumRndSelected4 == false)){
      numRound = 1;
     
    }
    else if (rdoNumEnm1.isSelected()){
      numEnemyPerRnd = 4;
